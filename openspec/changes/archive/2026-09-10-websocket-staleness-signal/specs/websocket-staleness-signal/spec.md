...
- **AND** this satisfies "introduces no new color or icon language" only because it introduces no visual language at all — it is not yet a rendering of either candidate register (dimmed/hollow vs. disconnected-adjacent) described in Decision D10
