...
- **AND** the `reauth-required` treatment's copy sign-off, visual-register mock sign-off, and live usability test are all open, tracked in GitHub issue #136
