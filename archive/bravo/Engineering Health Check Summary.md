...
- The set of topics can be added, removed or tweaked to better benefit the team. For example, the Perpetual Inventory team added the "Pairing" topic since returning from Pivotal Labs because it was something the team was struggling with on their own.
